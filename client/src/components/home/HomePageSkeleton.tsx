...
export const CategoryCardSkeleton: React.FC = () => {
  return (
    <div className="glass-panel border border-glass rounded-2xl p-6 flex flex-col justify-between h-64 shadow-luxury">
      ...
      {/* Footer item counter */}
      <div className="pt-5 border-t border-glass flex justify-between items-center">
