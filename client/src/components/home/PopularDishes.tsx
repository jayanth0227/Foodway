...
export const PopularDishes: React.FC = () => {
  ...
  return (
    <section id="popular-dishes" className="py-8 sm:py-12 md:py-16 bg-bg-dark border-t border-glass relative">
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10">
        ...
        {/* Section Header */}
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-6 sm:mb-8 space-y-4 md:space-y-0">
            ...
            {dishes.map((dish) => {
              ...
              return (
                <motion.div
                  ...
                  className={`group premium-card p-5 flex flex-col justify-between h-[490px] transition-all duration-300 ${isOutOfStock ? 'opacity-75 border-rose-500/20' : ''
                    }`}
                >
                  <div>
                    ...
                    <div className="relative h-56 rounded-2xl overflow-hidden border border-glass mb-5">
                      <img
                        src={dish.image}
                        alt={dish.name}
                        className={`w-full h-full object-cover transition-transform duration-[1.2s] ease-out ${isOutOfStock ? 'grayscale' : 'group-hover:scale-105'
                          }`}
                      />
                      ...
                      <div className="absolute top-3 left-3 z-20 flex gap-2">
                        <span
                          className={`text-[9px] font-bold uppercase tracking-widest px-2.5 py-1.2 rounded-lg shadow-lg ${dish.type === 'veg'
