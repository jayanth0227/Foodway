      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10">
        ...
        {loading ? (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[1, 2, 3].map(i => (
              <div key={i} className="glass-panel border border-glass rounded-3xl h-[420px] animate-pulse" />
            ))}
          </div>
              ...
              >
                ...
                <div className="relative h-56 overflow-hidden shrink-0 border-b border-glass bg-bg-dark">
                  ...
                  <div className="absolute top-4 right-4 z-20">
                    <span className={`text-[9px] font-black uppercase px-3 py-1 rounded-lg tracking-widest backdrop-blur-md border ${
                      item.isVeg !== false ? 'bg-emerald-500/80 text-white border-emerald-400/40' : 'bg-rose-600/80 text-white border-rose-500/40'
                    }`}>
