          ...
          <div className="space-y-3 max-w-md">
            ...
            <div className="flex items-center space-x-3 pt-1">
              <a
                ...
                title="Chat on WhatsApp (+91 9573041191)"
              >
          ...
          <div className="space-y-2.5">
            ...
            <ul className="space-y-2 text-xs text-text-muted font-medium">
              <li className="flex items-center space-x-2.5">
                ...
                <a href="mailto:mkdeliveryservices12@gmail.com" className="hover:text-primary transition-colors truncate">
                  mkdeliveryservices12@gmail.com
                </a>
              </li>
              <li className="flex items-center space-x-2.5">
                <Phone size={14} className="text-primary shrink-0" />
                <a href="tel:+919573041191" className="hover:text-primary transition-colors">
                  +91 9573041191
                </a>
              </li>
              <li className="flex items-start space-x-2.5">
                <MapPin size={14} className="text-primary shrink-0 mt-0.5" />
                <span>Ravulapalem-533238</span>
              </li>
            </ul>
          </div>
