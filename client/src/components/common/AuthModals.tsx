            ...
            >
              ...
              <div className="flex bg-stone-200/70 dark:bg-stone-800 p-1 rounded-2xl mb-5">
                <button
                  ...
                  className={`flex-1 py-2.5 rounded-xl text-xs font-extrabold uppercase tracking-wider transition-all ${type === 'login'
                ...
                <button
                  ...
                  className={`flex-1 py-2.5 rounded-xl text-xs font-extrabold uppercase tracking-wider transition-all ${type === 'register'
                    ? 'bg-[#A67C52] text-white shadow-md'
                    : 'text-stone-600 dark:text-stone-400 hover:text-stone-900 dark:hover:text-white'
                    }`}
                >
